...
生活在智能时代，我们更应当以积极的态度与理性的精神拥抱AI技术，充分利用AI模型和AI技术助力自身的学习发展，并以理性思考促进合理应用，不让自己沦为AIGC的搬运工；在可能的情况下，积极推动AI向新、向善。
...
简单来说，交叉熵在分类问题中更优，主要有两个层面的原因：1. 数学梯度层面 和 2. 概率意义层面。
...
我听说，用多项式拟合散点时，如果多项式次数过高，会导致次数越高，拟合效果越差。这似乎只是一个数学问题。这和我们机器学习中维数灾难，密度下降等导致的过拟合有本质联系吗？
...
在解释过拟合的成因时，我们谈论的维数是模型参数的维数；但是我们刚才举例说到图片的像素数大导致维数增大时，指的是样本的特征维数。“维数灾难”中的维数是指哪一个？难道样本维数增大必然导致模型维数增大吗？
